...
mapMeasureHint: $('mapMeasureHint'),
    ...
    try {
      localStorage.setItem(
        ...
        JSON.stringify({
          ...
          sequence: mapRoadPlannerSequence,
  ...
  // PWA v117 — библиотека именованных пользовательских маршрутов.
